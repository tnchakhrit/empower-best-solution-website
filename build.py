  ...
  <div class="stack-row" style="display:flex; gap:48px; padding:88px 64px 56px 64px; align-items:flex-start;">
    ...
    <div style="flex:1; min-width:280px; max-width:380px; display:flex; flex-direction:column; gap:16px; padding:32px; background:#1E3A28; border-radius:10px; margin-top:6px;">
      <div style="display:flex; align-items:center; gap:10px;">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 3a5 5 0 0 0-5 5v3.4c0 .9-.3 1.8-.9 2.5L4.5 16h15L18 13.9c-.6-.7-.9-1.6-.9-2.5V8a5 5 0 0 0-5-5Z" stroke="#BE7C3E" stroke-width="1.6" stroke-linejoin="round"/><path d="M9.5 19a2.5 2.5 0 0 0 5 0" stroke="#BE7C3E" stroke-width="1.6" stroke-linecap="round"/></svg>
        <span style="font-family:'IBM Plex Mono',monospace; font-size:11px; letter-spacing:2px; color:#BE7C3E; text-transform:uppercase;">ฟีเจอร์ใหม่ · ไม่มีค่าใช้จ่าย</span>
      </div>
      ...
      <a href="reminder-program.html" class="btn-amber" style="background:#BE7C3E; color:#FFFFFF; padding:13px 22px; border-radius:5px; border:none; font-family:'Noto Sans Thai',sans-serif; font-weight:600; font-size:14px; cursor:pointer; text-align:center; text-decoration:none;">ลงทะเบียนรับการแจ้งเตือนฟรี</a>
    </div>
  </div>
