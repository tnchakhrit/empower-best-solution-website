    ...
    <div class="footer-cols" style="display:flex; gap:80px;">
      <div style="display:flex; flex-direction:column; gap:16px; width:320px;">
        ...
        <div style="display:flex; gap:10px; margin-top:8px;">
          <a href="https://line.me/ti/p/@911hrhms" target="_blank" rel="noopener" style="width:34px; height:34px; border:1px solid rgba(247,242,227,0.3); border-radius:50%; display:flex; align-items:center; justify-content:center;"><svg width="15" height="15" viewBox="0 0 24 24" fill="none"><path d="M12 3C6.5 3 2 6.6 2 11c0 2.8 1.8 5.3 4.6 6.8L6 21l3.7-1.9c.7.1 1.5.2 2.3.2 5.5 0 10-3.6 10-8s-4.5-8.3-10-8.3Z" stroke="#F7F2E3" stroke-width="1.5" stroke-linejoin="round"/></svg></a>
          <a href="https://www.facebook.com/profile.php?id=61593862637826" target="_blank" rel="noopener" style="width:34px; height:34px; border:1px solid rgba(247,242,227,0.3); border-radius:50%; display:flex; align-items:center; justify-content:center;"><svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M15 4h-2a4 4 0 0 0-4 4v3H6v4h3v9h4v-9h3l1-4h-4V8a1 1 0 0 1 1-1h3Z" stroke="#F7F2E3" stroke-width="1.5" stroke-linejoin="round"/></svg></a>
...
def page(title, description, active_href, main_content, extra_head="", url_path=None):
  ...
  "areaServed": "TH",
  "sameAs": [
    "https://www.facebook.com/profile.php?id=61593862637826",
    "https://line.me/ti/p/@911hrhms"
  ]
}'''
...
REMINDER_MAIN = '''
  ...
  <div style="display:flex; flex-direction:column; gap:28px; padding:0 64px 72px 64px;">
    ...
    <div class="grid-2">
      <div style="display:flex; flex-direction:column; gap:16px; padding:32px; background:#1E3A28; border-radius:10px;">
        ...
        <h3 style="margin:0; font-family:'Noto Serif Thai',serif; font-weight:700; font-size:20px; color:#F7F2E3;"><span class="mobile-line-heading">ตั้งเตือนวันตรวจอาคารผ่าน LINE ฟรี</span><span id="line-heading-desktop">ลงทะเบียนผ่าน LINE</span></h3>
        <p id="line-intro-desktop-text" style="margin:0; font-family:'Noto Sans Thai',sans-serif; font-size:13.5px; line-height:1.8; color:rgba(247,242,227,0.8);">ขั้นตอนที่ 1 เพิ่มเพื่อน LINE OA ก่อน จากนั้นกดปุ่ม "ลงทะเบียนรับการแจ้งเตือนฟรี" ในแชท LINE เพื่อกรอกข้อมูล รับแจ้งเตือนทั้งทาง LINE และอีเมล</p>

        <div class="mobile-line-block" style="flex-direction:column; gap:14px;">
          <p style="margin:0; font-family:'Noto Sans Thai',sans-serif; font-size:13.5px; line-height:1.8; color:rgba(247,242,227,0.85);">กดปุ่มด้านล่างเพื่อแอด LINE (@911hrhms) แล้วแจ้งวันตรวจล่าสุดได้ทันที ไม่ต้องกรอกฟอร์มซับซ้อน</p>
          <a href="https://line.me/R/ti/p/%40911hrhms" target="_blank" rel="noopener" style="display:flex; align-items:center; justify-content:center; gap:8px; background:#06C755; color:#FFFFFF; padding:16px 24px; border-radius:6px; font-family:'Noto Sans Thai',sans-serif; font-weight:700; font-size:15px; text-decoration:none;">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 3a5 5 0 0 0-5 5v3.4c0 .9-.3 1.8-.9 2.5L4.5 16h15L18 13.9c-.6-.7-.9-1.6-.9-2.5V8a5 5 0 0 0-5-5Z" stroke="#FFFFFF" stroke-width="1.6" stroke-linejoin="round"/></svg>
            เพิ่มเพื่อนและตั้งเตือนผ่าน LINE
          </a>
        </div>
        ...
        <div id="line-step2-block" style="display:flex; flex-direction:column; gap:8px;">
          ...
          <div style="display:flex; align-items:center; justify-content:center; gap:8px; background:rgba(247,242,227,0.08); border:1.4px dashed rgba(247,242,227,0.35); padding:13px 20px; border-radius:5px; text-align:center;">
            ...
            <span style="font-family:'Noto Sans Thai',sans-serif; font-weight:600; font-size:13.5px; color:#F7F2E3;">เปิดแชท Empower Best Solution ใน LINE แล้วกด "ลงทะเบียนรับการแจ้งเตือนฟรี"</span>
          </div>
      ...
      <div id="reminder-website-box" style="display:flex; flex-direction:column; gap:16px; padding:32px; background:#FFFFFF; border:1px solid #E4DCC8; border-radius:10px;">
        <div style="display:flex; align-items:center; gap:10px;">
  ...
  <!-- FORM -->
  <div id="reminder-form-row" class="stack-row" style="display:flex; gap:56px; padding:0 64px 72px 64px;">
...
ARTICLE_SCHEDULE_MAIN = article_page_main(
    ...
    article_section(
        ...
        article_p("เป็นการตรวจสอบอาคารและอุปกรณ์ประกอบอย่างละเอียดครบทุกระบบ ทั้งโครงสร้างอาคาร ระบบไฟฟ้า ระบบประปา ระบบระบายอากาศ ระบบป้องกันอัคคีภัย ลิฟต์ และระบบอื่นๆ ที่เกี่ยวข้องกับความปลอดภัย ต้องทำครั้งแรกภายในระยะเวลาที่กฎหมายกำหนดหลังอาคารได้รับหนังสือรับรองการใช้อาคาร (แบบ อ.6) จากนั้นทำซ้ำทุก 5 ปี")
...
ARTICLE_POR1_MAIN = article_page_main(
    ...
    "ใบ ร.1 เป็นเอกสารสำคัญที่เจ้าของอาคารควบคุมต้องมีไว้ แต่หลายคนยังสับสนว่าต่างจากหนังสือรับรองการใช้อาคาร (อ.6) อย่างไร และต้องขอยังไง",
    article_section(
        ...
        + article_p("ต่างจากหนังสือรับรองการใช้อาคาร (อ.6) ซึ่งเป็นการรับรองว่าอาคารก่อสร้างแล้วเสร็จถูกต้องตามแบบและสามารถใช้อาคารได้ตั้งแต่แรก — ใบ ร.1 คือการรับรอง <em>สภาพอาคารหลังใช้งานแล้ว</em> ต้องยื่นขอใหม่ทุกครั้งที่มีการตรวจสอบตามรอบ (ทั้งตรวจสอบใหญ่และตรวจสอบประจำปี)")
    )
    + article_section(
        "ขั้นตอนการขอใบ ร.1",
        article_list([
            ...
            "เจ้าของอาคารหรือผู้รับมอบอำนาจนำรายงานไปยื่นต่อเจ้าพนักงานท้องถิ่นในพื้นที่ที่อาคารตั้งอยู่",
        ])
    )
    + article_section(
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUT_DIR, "por-1-certificate.html"), "w", encoding="utf-8") as f:
        f.write(page(
            ...
            "ใบ ร.1 คือใบรับรองการตรวจสอบสภาพอาคาร ต่างจากหนังสือรับรองการใช้อาคาร อ.6 อย่างไร ขั้นตอนขอใบ ร.1 ยื่นที่ไหน ใช้เอกสารอะไรบ้าง อ่านสรุปได้ที่นี่",
            "legal-knowledge.html",
            ARTICLE_POR1_MAIN,
